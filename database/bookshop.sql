...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 24, 2020 at 03:38 PM
...
INSERT INTO `customers` (`customerid`, `name`, `password`, `address`, `city`, `zip_code`, `country`) VALUES
(8, 'akash', '123', '', '', '', '');
...
(1, 23.7408, 90.4128, 'PBS Book Shop', 'shantinagar pbs book shop'),
(2, 23.7992, 90.3845, 'National Library', 'mirpur national library'),
(3, 23.7912, 90.4079, 'Boi Bichitra', 'gulshan banani boi bichitra'),
(4, 23.7327, 90.3851, 'New Mukta Library', 'nilkhet new mukta library'),
(5, 23.7534, 90.3692, 'Bangla Boi', 'lalmatia dhanmondi bangla boi'),
(6, 23.7545, 90.3761, 'Gyankosh', 'mirpur mirpur10 gyankosh'),
(7, 23.7721, 90.3895, 'The Book Worm', 'mohakhali farmgate the book worm');
...
(12, 8, '20.00', '2019-03-31 04:21:50', 'sweet', '', '', '', '');
...
INSERT INTO `users` (`user_id`, `firstname`, `lastname`, `phone`, `email`, `password`) VALUES
(1, 'SHAHRIAR', 'AKASH', 152155, 'ak@gmail.com', '123'),
(6, 't', 't', 1584, 'doitbffd.com@gmail.com', '1234');
